...
namespace BookWorm.BusinessLogic.Services
{
  public class BookService
  {
    ...
    public async Task<PaginatedReducedBook> GetBookByTitleOrAuthorNameAsync(string searchQuery, int? page = 0, int? minYear = null, int? maxYear = null, bool? onlyReview = null, string? uid = null, string? order = null)
    {
      try
      {
    ...
    {
      return await _bookRepository.GetBookRatingByIdAsync(bookId);
    }
  }
}
