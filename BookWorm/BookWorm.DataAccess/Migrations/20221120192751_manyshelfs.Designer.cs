...
namespace BookWorm.DataAccess.Migrations
{
    ...
    [Migration("20221120192751_manyshelfs")]
    partial class manyshelfs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookWorm.DataAccess.Data.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BookBookShelf", b =>
                {
                    b.HasOne("BookWorm.DataAccess.Data.Models.Book", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BookWorm.DataAccess.Data.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
